...
- Supabase account (for authentication, see below for more details on local setup)
...
- **Port conflicts:** If ports 54321 or 54323 are already in use, edit `.env.local` in your Supabase directory and change the ports
